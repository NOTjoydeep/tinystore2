# Generated by Django 4.1 on 2022-08-25 09:42
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('storeapp', '0006_alter_collection_options_alter_product_options_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='product',
            name='collection',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='products', to='storeapp.collection'),
        ),
        migrations.AlterField(
            model_name='product',
            name='description',
